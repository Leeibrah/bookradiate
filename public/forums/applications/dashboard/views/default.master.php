...
<body id="<?php echo $BodyIdentifier; ?>" class="<?php echo $this->CssClass; ?>">
   <div id="Frame">
      <div id="Head">
         <div class="Menu">
            <h1><a class="Title" href="<?php echo Url('http://localhost:8000/'); ?>"><span><?php echo Gdn_Theme::Logo(); ?></span></a></h1>
            <ul class="linkbar top1">
            	<a href="http://localhost:8000/howitworks"><li>How it Works</li></a> |
            	<a href="http://localhost:8000/forums"><li>Forum</li></a> | 
                <a href="http://localhost:8000/blog"><li>Blog</li></a> | 
                <a href="http://localhost:8000/contactus"><li>Contact Us</li></a> <br />
